                    ...
                    <header className={classes.header}>
                        ...
                        <div className={classes.introductionContainer}>
                            ...
                            <p className={classes.introduction}>
                                ...
                                В конце лета 2021 увлекся разработкой и пошел на курсы в Нетологию.
                                Успешно обогнал курс и вышел за его рамки.
                                Изучил учебник на learn.javascript.ru и прошел курс React на Udemy.
                                Набивал руку и шишки на пет-проектах.
                            </p>
                        </div>
                    </header>
                    <main className={classes.main}>
                        <span className={classes.annotation}>
                            Мои учебные проекты на React & TypeScript 👇
                        </span>
                            ...
                            <Link className={classes.link} to='/auth'>
                                <div className={classes.card} onMouseEnter={showTextAuth} onMouseLeave={hideTextAuth}>
                                    ...
                                    {isTextAuthShowen && <p className={classes.parag} >
                                        Модуаль авторизации с регистрацией.
                                        Сделано на Firebase.
